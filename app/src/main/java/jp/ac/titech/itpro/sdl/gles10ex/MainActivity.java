...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private RegularOctahedron regularOctahedron;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cube = new Cube();
        pyramid = new Pyramid();
        regularOctahedron = new RegularOctahedron();
    ...
    @Override
        ...
        case R.id.item_pyramid:
            ...
            break;
        case R.id.item_regularOctahedron:
            renderer.setObj(regularOctahedron, 0, 0, 0);
        }
        return true;
    }
